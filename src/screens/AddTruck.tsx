            ...
            <div className="container-fluid px-5">
              <div className="row mt-5 mb-3">
                <div className="col d-flex justify-content-start align-items-center gap-3">
                  ...
                  <button
                    className="btn btn-primary rounded-pill p-size fw-medium px-4"
                    type="button"
                  >
                    ...
                    <div className="card-body px-xl-5 mx-xl-5">
                      <div className="row mb-5 justify-content-between align-items-center">
                        <div className="col col-12 col-lg-5">
                          ...
                          <input
                            type="text"
                            className="w-100 px-4 py-3 t-input"
                          />
                        </div>
                        <div className="col col-12 col-lg-5">
                          <p className="mb-1 l-h l-color fw-normal">
                      ...
                      <div className="row mb-5 justify-content-between align-items-center">
                        <div className="col col-12 col-lg-5">
                          ...
                          <div className="dropdown w-100">
                            <button
                              className="btn btn-primary dropdown-toggle t-input px-4 py-3 w-100 d-flex justify-content-between align-items-center"
                              aria-expanded="false"
                        ...
                        <div className="col col-12 col-lg-5">
                          ...
                          <input
                            className="t-input px-4 py-3 w-100 pri-color d-flex justify-content-between align-items-center"
                            type="date"
                          />
                        </div>
                      </div>
                      ...
                      <div className="row mb-5 justify-content-between align-items-center">
                        ...
                        <div className="col col-12 col-lg-5">
                          ...
                          >
                            <button
                              className="btn btn-primary w-100 px-4 py-3 rounded-pill fw-medium"
                              type="button"
                            >
                              Submit
                            </button>
